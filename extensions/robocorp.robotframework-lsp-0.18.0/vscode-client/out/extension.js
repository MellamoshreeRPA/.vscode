...
exports.activate = exports.OUTPUT_CHANNEL = void 0;
...
exports.OUTPUT_CHANNEL = vscode_1.window.createOutputChannel(OUTPUT_CHANNEL_NAME);
function createClientOptions(initializationOptions) {
    const clientOptions = {
        ...
        outputChannel: exports.OUTPUT_CHANNEL,
...
function registerDebugger(languageServerExecutable) {
    ...
    try {
        ...
        exports.OUTPUT_CHANNEL.appendLine('Error registering debugger: ' + error);
    }
}
function getDefaultLanguageServerPythonExecutable() {
    return __awaiter(this, void 0, void 0, function* () {
        exports.OUTPUT_CHANNEL.appendLine("Getting language server Python executable.");
        ...
        if (!executable || (executable.indexOf('/') == -1 && executable.indexOf('\\') == -1)) {
            ...
            try {
                ...
                if (languageServerPython) {
                    exports.OUTPUT_CHANNEL.appendLine("Language server Python executable gotten from robocorp.getLanguageServerPython.");
                    return {
            ...
            if (!executable) {
                exports.OUTPUT_CHANNEL.appendLine("Language server Python executable. Searching in PATH.");
                ...
                exports.OUTPUT_CHANNEL.appendLine("Language server Python executable. Searching " + executable + " from the PATH.");
                executable = findExecutableInPath(executable);
                exports.OUTPUT_CHANNEL.appendLine("Language server Python executable. Found: " + executable);
            }
            if (!fs.existsSync(executable)) {
                return {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (executableAndMessage.message) {
                exports.OUTPUT_CHANNEL.appendLine(executableAndMessage.message);
                ...
                if (selection == saveInUser || selection == saveInWorkspace) {
                    ...
                    if (!onfulfilled || onfulfilled.length == 0) {
                        ...
                        exports.OUTPUT_CHANNEL.appendLine("Unable to start (python selection cancelled).");
                        return;
                    }
                    ...
                    try {
                        ...
                        exports.OUTPUT_CHANNEL.appendLine(errorMessage);
                    ...
                    // There's not much we can do (besides start listening to changes to the related variables
                    // on the finally block so that we start listening and ask for a reload if a related configuration changes).
                    exports.OUTPUT_CHANNEL.appendLine("Unable to start (no python executable specified).");
                    return;
                }
            }
            ...
            try {
                ...
                try {
                    if (pluginsDir && pluginsDir.length > 0) {
                        exports.OUTPUT_CHANNEL.appendLine("Plugins dir: " + pluginsDir + ".");
                        initializationOptions['pluginsDir'] = pluginsDir;
                    }
                }
                catch (error) {
                    exports.OUTPUT_CHANNEL.appendLine(error);
                }
            }
            catch (error) {
            ...
            if (port) {
                ...
                exports.OUTPUT_CHANNEL.appendLine("Connecting to port: " + port);
                ...
                exports.OUTPUT_CHANNEL.appendLine("Starting RobotFramework Language Server with args: " + executableAndMessage.executable + "," + args);
            ...
            exports.OUTPUT_CHANNEL.appendLine("Waiting for RobotFramework (python) Language Server to finish activating...");
            ...
            try {
                ...
                if (lsVersion != version) {
                    vscode_1.window.showErrorMessage('Error: expected robotframework-lsp version: ' + version + '. Found: ' + lsVersion + '.' +
                        ' Please uninstall the older version from the python environment.');
                }
            }
            catch (err) {
                vscode_1.window.showErrorMessage('Error: robotframework-lsp version mismatch. Please uninstall the older version from the python environment.');
            }
            ...
            exports.OUTPUT_CHANNEL.appendLine("RobotFramework Language Server ready. Took: " + timing.getTotalElapsedAsStr());
        }
        finally {
